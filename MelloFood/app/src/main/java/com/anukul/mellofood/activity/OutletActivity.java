...
import com.anukul.mellofood.adapter.OutletAdapter;
...
public class OutletActivity extends AppCompatActivity implements OutletOnItemClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTitleTv.setText("OUTLETS");
        ...
        outletModelArrayList.add(new OutletModel("Himalaya Mall", R.mipmap.himalayamall));
        outletModelArrayList.add(new OutletModel("Alpha One Mall", R.mipmap.himalayamall));
        outletModelArrayList.add(new OutletModel("Central Mall", R.mipmap.himalayamall));
        outletModelArrayList.add(new OutletModel("Iscon Mall", R.mipmap.himalayamall));
        outletModelArrayList.add(new OutletModel("Honest", R.mipmap.himalayamall));
        outletModelArrayList.add(new OutletModel("Reliance Mall", R.mipmap.himalayamall));
    ...
    public void outletOnItemClick(OutletModel outletModel) {
        ...
        intent.putExtra("KEY_TITLE", outletModel.getMallName());
