...
import com.anukul.sqliteandroomtest.app.ContactDbConstant;
...
public class ContactDbHelper extends SQLiteOpenHelper {
    ...
    public long insertContact(ContactModel contactModel, SQLiteDatabase sqLiteDatabase){
        ...
        contentValues.put(ContactDbConstant.CONTACT_COLUMN_NAME,contactModel.getfName());
        contentValues.put(ContactDbConstant.CONTACT_COLUMN_LNAME,contactModel.getlName());
   ...
   //read data
    public ArrayList<ContactModel> getAllUser() {
        ...
        while (cursor.moveToNext()){
            ...
            contactModel.setfName(cursor.getString(cursor.getColumnIndex(ContactDbConstant.CONTACT_COLUMN_NAME)));
            contactModel.setlName(cursor.getString(cursor.getColumnIndex(ContactDbConstant.CONTACT_COLUMN_LNAME)));
